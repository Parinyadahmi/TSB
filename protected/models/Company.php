...
class Company extends CActiveRecord
{
	...
	public function relations()
	{
		return array(
				...
				'scheduleCompany' => array(self::HAS_MANY, 'Schedule', 'company_id'),
				'promotionCompany' => array(self::HAS_MANY, 'Promotion', 'company_id'),
				'bookingData' => array(self::HAS_MANY, 'BookingData', 'company_id'),
		);
	}
